        ...
        <div className="footer-grid">
          <div>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
              ...
              <a href="#twitter" aria-label="Twitter/X" style={{ color: '#fff', transition: 'color 0.3s ease' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--c-yellow)'} onMouseOut={(e) => e.currentTarget.style.color = '#fff'}>
